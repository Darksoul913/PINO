...
class TestPhysics(unittest.TestCase):
    def test_exact_spectral_derivatives(self):
        s_x, s_y = 64, 64
        ...
        self.assertLess(err_dx, 1e-3)
        self.assertLess(err_dy, 1e-3)
        self.assertLess(err_lap, 1e-3)

    def test_pino_loss_engine(self):
        ...
        self.assertIn("loss_ic", losses)
        self.assertIn("loss_data", losses)
        self.assertIn("loss_pde", losses)
        self.assertFalse(torch.isnan(losses["loss_total"]).any())
